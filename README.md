...
# 📖 Greate Ethiopian motivational speakers 2023: <a name="about-project"></a>

> GEM speakers 2023 project is created using HTML, CSS and javascript. Here on the project, I prepared home and about page for both mobile and desktop users by relying on the design template.
...
``git clone `https://github.com/yodit93/First-capstone-project`
...
Feel free to check the [issues page](https://github.com/yodit93/First-capstone-project/issues).
